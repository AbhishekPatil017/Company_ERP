...
class Company(models.Model):
    ...
    gst_no=models.CharField(max_length=60,blank=True,null=True)
    hsn_sac=models.CharField(max_length=60,blank=True,null=True)
    bank_details=models.CharField(max_length=30,blank=True,null=True)
    bank_account=models.CharField(max_length=30,blank=True,null=True)
    pan_details=models.CharField(max_length=12,blank=True,null=True)
